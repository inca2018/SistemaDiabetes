...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-03-2019 a las 11:10:04
...
--
ALTER TABLE `tab_resultado_ficha`
  MODIFY `idResultadoFicha` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tab_resultado_pie`
--
ALTER TABLE `tab_resultado_pie`
  MODIFY `idResultadoPie` int(11) NOT NULL AUTO_INCREMENT;
