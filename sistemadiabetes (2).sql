...
-- Tiempo de generación: 30-11-2018 a las 12:24:26
...
--
-- Estructura de tabla para la tabla `modulo_informacion`
--

DROP TABLE IF EXISTS `modulo_informacion`;
CREATE TABLE IF NOT EXISTS `modulo_informacion` (
...
--
-- Estructura de tabla para la tabla `modulo_otraespecialidad`
--

DROP TABLE IF EXISTS `modulo_otraespecialidad`;
CREATE TABLE IF NOT EXISTS `modulo_otraespecialidad` (
  `idModulo_OtraEspecialidad` int(11) NOT NULL AUTO_INCREMENT,
  `Campo1` varchar(150) DEFAULT NULL,
  `Estado1` int(2) DEFAULT NULL,
  `Campo2` varchar(150) DEFAULT NULL,
  `Estado2` int(2) DEFAULT NULL,
  `Campo3` varchar(150) DEFAULT NULL,
  `Estado3` int(2) DEFAULT NULL,
  `Campo4` varchar(150) DEFAULT NULL,
  `Estado4` int(2) DEFAULT NULL,
  `Campo5` varchar(150) DEFAULT NULL,
  `Estado5` int(2) DEFAULT NULL,
  `Campo6` varchar(150) DEFAULT NULL,
  `Estado6` int(2) DEFAULT NULL,
  `Campo7` varchar(150) DEFAULT NULL,
  `Estado7` int(2) DEFAULT NULL,
  `Campo8` varchar(150) DEFAULT NULL,
  `Estado8` int(2) DEFAULT NULL,
  `Campo9` varchar(150) DEFAULT NULL,
  `Estado9` int(2) DEFAULT NULL,
  PRIMARY KEY (`idModulo_OtraEspecialidad`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `modulo_otros`
--

DROP TABLE IF EXISTS `modulo_otros`;
CREATE TABLE IF NOT EXISTS `modulo_otros` (
  `idModuloOtro` int(11) NOT NULL AUTO_INCREMENT,
  `op_comorbilidad` text,
  `op_complicaciones` text,
  `op_tratamiento` text,
  `op_tratamiento_respuesta` text,
  `op_otro_tratamiento` text,
  `op_examen_Diabetico` text,
  `op_valoracion_calzado` text,
  `op_evaluacion` text,
  `op_ficha_fecha1` text,
  `op_ficha_fecha2` text,
  `op_ficha_fecha3` text,
  PRIMARY KEY (`idModuloOtro`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `modulo_seguimiento`
--

DROP TABLE IF EXISTS `modulo_seguimiento`;
CREATE TABLE IF NOT EXISTS `modulo_seguimiento` (
  `idModuloSeguimiento` int(11) NOT NULL AUTO_INCREMENT,
  `Campo1` varchar(150) DEFAULT NULL,
  `Campo2` decimal(11,2) DEFAULT NULL,
  `Campo3` decimal(11,2) DEFAULT NULL,
  `Campo4` decimal(11,2) DEFAULT NULL,
  `Campo5` decimal(11,2) DEFAULT NULL,
  `Campo6` decimal(11,2) DEFAULT NULL,
  `Campo7` decimal(11,2) DEFAULT NULL,
  `Campo8` decimal(11,2) DEFAULT NULL,
  `Campo9` decimal(11,2) DEFAULT NULL,
  `Campo10` decimal(11,2) DEFAULT NULL,
  `Talla` decimal(11,2) DEFAULT NULL,
  `Peso` decimal(11,2) DEFAULT NULL,
  `Campo11` decimal(11,2) DEFAULT NULL,
  `Campo12` decimal(11,2) DEFAULT NULL,
  `Campo13` decimal(11,2) DEFAULT NULL,
  `Campo14` decimal(11,2) DEFAULT NULL,
  PRIMARY KEY (`idModuloSeguimiento`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `modulo_seguimiento_paciente` (
  ...
  `op_seguimiento` text,
  `op_especialidadEstado` text,
  `op_espcialidadInfo` text,
  `op_grado_instruccion` text,
  `op_comorbilidad` text,
  `op_complicaciones` text,
  `op_tratamientoEstado` text,
  `op_tratamientoInfo` text,
  `op_otro_tratamiento` text,
  `op_examen` text,
  `op_valoracion` text,
  `op_evaluacion` text,
  `op_fecha1` int(11) DEFAULT NULL,
  `op_fecha2` int(11) DEFAULT NULL,
  `op_fecha3` int(11) DEFAULT NULL,
  `Riesgo` text,
  `FechaInicio` date DEFAULT NULL,
  `Observaciones` text,
  `Talleres` text,
  `FechaProximaCita` text,
