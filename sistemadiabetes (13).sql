...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-03-2019 a las 14:04:11
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_CRUD_PACIENTE` (IN `Operacion` VARCHAR(150), IN `idPaciente` INT(11), IN `PaCodigo` VARCHAR(150), IN `PaNombres` VARCHAR(150), IN `PaApePa` VARCHAR(150), IN `PaApeMa` VARCHAR(150), IN `PafechaNac` DATE, IN `PaEdad` INT(11), IN `PanumeroDoc` INT(11), IN `PaTelefono` CHAR(11), IN `PaCelular` CHAR(11), IN `PaCorreo` VARCHAR(150), IN `PaDirec` TEXT, IN `PaTipoMedida` INT(11), IN `PaCantidad` INT(11), IN `PaSexo` INT(11), IN `PaDx` INT(11), IN `PaMedico` INT(11), IN `PaTipoDoc` INT(11), IN `PaDepa` INT(11), IN `PaProv` INT(11), IN `PaDist` INT(11), IN `PaCond` INT(11), IN `PaGrado` INT(11), IN `PaTitulo` TEXT)  NO SQL
BEGIN 
DECLARE CRUD text;

IF(idPaciente="-1" or idPaciente=-1)THEN 
SET idPaciente=NULL; 
END IF;

IF(PaCodigo="-1" or PaCodigo=-1)THEN 
SET PaCodigo=NULL; 
END IF; 
IF(PaNombres="-1" or PaNombres=-1)THEN 
SET PaNombres=NULL; 
END IF; 
IF(PaApePa="-1" or PaApePa=-1)THEN 
SET PaApePa=NULL; 
END IF;  
 IF(PaApeMa="-1" or PaApeMa=-1)THEN 
SET PaApeMa=NULL; 
END IF; 
 IF(PafechaNac="-1" or PafechaNac=-1)THEN 
SET PafechaNac=NULL; 
END IF;
IF(PaEdad="-1" or PaEdad=-1)THEN 
SET PaEdad=NULL; 
END IF; 
 IF(PanumeroDoc="-1" or PanumeroDoc=-1)THEN 
SET PanumeroDoc=NULL; 
END IF; 
IF(PaTelefono="-1" or PaTelefono=-1)THEN 
SET PaTelefono=NULL; 
END IF;  
IF(PaCelular="-1" or PaCelular=-1)THEN 
SET PaCelular=NULL; 
END IF;   
 IF(PaCorreo="-1" or PaCorreo=-1)THEN 
SET PaCorreo=NULL; 
END IF;  
 IF(PaDirec="-1" or PaDirec=-1)THEN 
SET PaDirec=NULL; 
END IF;  
 IF(PaTipoMedida="-1" or PaTipoMedida=-1)THEN 
SET PaTipoMedida=NULL; 
END IF; 
  IF(PaCantidad="-1" or PaCantidad=-1)THEN 
SET PaCantidad=NULL; 
END IF; 
  IF(PaSexo="-1" or PaSexo=-1)THEN 
SET PaSexo=NULL; 
END IF; 
  IF(PaDx="-1" or PaDx=-1)THEN 
SET PaDx=NULL; 
END IF; 
 IF(PaMedico="-1" or PaMedico=-1)THEN 
SET PaMedico=NULL; 
END IF; 
IF(PaTipoDoc="-1" or PaTipoDoc=-1)THEN 
SET PaTipoDoc=NULL; 
END IF;  
IF(PaDepa="-1" or PaDepa=-1)THEN 
SET PaDepa=NULL; 
END IF;  
 IF(PaProv="-1" or PaProv=-1)THEN 
SET PaProv=NULL; 
END IF; 
 IF(PaDist="-1" or PaDist=-1)THEN 
SET PaDist=NULL; 
END IF;  
  IF(PaCond="-1" or PaCond=-1)THEN 
SET PaCond=NULL; 
END IF;  
 IF(PaGrado="-1" or PaGrado=-1)THEN 
SET PaGrado=NULL; 
END IF;  
 IF(PaTitulo="-1" or PaTitulo=-1)THEN 
SET PaTitulo=NULL; 
END IF; 
...
INSERT INTO `tab_paciente`(`idPaciente`, `Codigo`, `Nombres`, `apellidoPaterno`, `apellidoMaterno`, `fechaNacimiento`, `edad`, `numeroDocumento`, `Telefono`, `Celular`, `Correo`, `Direccion`, `TipoMedida_idTipoMedida`, `CantidadTiempo`, `Sexo_idSexo`, `DX_idDX`, `Medico_idMedico`, `TipoDocumento_idTipoDocumento`, `Departamento_idDepartamento`, `Provincia_idProvincia`, `Distrito_idDistrito`, `Condicion_idCondicion`, `Estado_idEstado`, `fechaRegistro`,`GradoInstruccion_idGradoInstruccion`,`tituloGrado`) VALUES (NULL,PaCodigo,UPPER(PaNombres),UPPER(PaApePa),UPPER(PaApeMa),PafechaNac,PaEdad,PanumeroDoc,PaTelefono,PaCelular,PaCorreo,PaDirec,PaTipoMedida,PaCantidad,PaSexo,PaDx,PaMedico,PaTipoDoc,PaDepa,PaProv,PaDist,PaCond,1,NOW(),PaGrado,PaTitulo);  

ELSEIF(Operacion="EDITAR") then 


UPDATE `tab_paciente` SET  `Nombres`=UPPER(PaNombres),`apellidoPaterno`=UPPER(PaApePa),`apellidoMaterno`=UPPER(PaApeMa),`fechaNacimiento`=PafechaNac,`edad`=PaEdad,`numeroDocumento`=PanumeroDoc,`Telefono`=PaTelefono,`Celular`=PaCelular,`Correo`=PaCorreo,`Direccion`=PaDirec,`TipoMedida_idTipoMedida`=PaTipoMedida,`CantidadTiempo`=PaCantidad,`DX_idDX`=PaDx,`Medico_idMedico`=PaMedico,`TipoDocumento_idTipoDocumento`=PaTipoDoc,`Departamento_idDepartamento`=PaDepa,`Provincia_idProvincia`=PaProv,`Distrito_idDistrito`=PaDist,`Condicion_idCondicion`=PaCond,`GradoInstruccion_idGradoInstruccion`=PaGrado,`tituloGrado`=PaTitulo,`Sexo_idSexo`=PaSexo WHERE `idPaciente`=idPaciente;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_REGISTRAR_RESULTADOS` (IN `id` INT(11), IN `tipoGeneral` VARCHAR(150), IN `tipoOpcion` INT(11), IN `campo` TEXT, IN `Respuesta` TEXT, IN `Estado` INT(11), IN `Sexo` INT(11), IN `v1` VARCHAR(150), IN `v2` VARCHAR(150), IN `v3` VARCHAR(150), IN `v4` VARCHAR(150), IN `tipoCampo` VARCHAR(150), IN `valorCampo` VARCHAR(150), IN `Dosis` VARCHAR(150), IN `Num` VARCHAR(150), IN `Diag` INT(11), IN `Medico` INT(11), IN `Tratamiento` VARCHAR(150), IN `Observacion` TEXT, IN `r1` INT(11), IN `r2` INT(11), IN `r3` INT(11), IN `r4` INT(11), IN `r5` INT(11), IN `r6` INT(11), IN `r7` INT(11), IN `r8` INT(11), IN `idSeguimiento` INT(11))  NO SQL
BEGIN 
...
if(tipoGeneral="OPCION")THEN 
    ...
    INSERT INTO `tab_resultado_ficha`(`idResultadoFicha`, `Seguimiento_idSeguimiento`, `Opcion_Opcion`, `Especialidad_idEspecialidad`, `TipoOpcion`, `Propiedades`, `RespuestaTexto`, `RespuestaValor`, `RespuestaFecha`, `RespuestaAdecuado`, `TipoListado`, `fechaRegistro`) VALUES (NULL,idSeguimiento,id,NULL,2,NULL,campo,NULL,NULL,NULL,NULL,NOW());

    ELSEIF(tipoOpcion="3") THEN 

    INSERT INTO `tab_resultado_ficha`(`idResultadoFicha`, `Seguimiento_idSeguimiento`, `Opcion_Opcion`, `Especialidad_idEspecialidad`, `TipoOpcion`, `Propiedades`, `RespuestaTexto`, `RespuestaValor`, `RespuestaFecha`, `RespuestaAdecuado`, `TipoListado`, `fechaRegistro`) VALUES (NULL,idSeguimiento,id,NULL,3,NULL,NULL,Respuesta,NULL,Estado,NULL,NOW()); 

    ELSEIF(tipoOpcion="4")THEN 

    SET @propiedades=(CONCAT('{"Sexo":',Sexo,'}'));

    INSERT INTO `tab_resultado_ficha`(`idResultadoFicha`, `Seguimiento_idSeguimiento`, `Opcion_Opcion`, `Especialidad_idEspecialidad`, `TipoOpcion`, `Propiedades`, `RespuestaTexto`, `RespuestaValor`, `RespuestaFecha`, `RespuestaAdecuado`, `TipoListado`, `fechaRegistro`) VALUES (NULL,idSeguimiento,id,NULL,4,@propiedades,NULL,Respuesta,NULL,Estado,NULL,NOW()); 

    ELSEIF(tipoOpcion="5")THEN 

    SET @Fecha=(DATE_FORMAT(campo,"%Y-%m-%d")); 
    INSERT INTO `tab_resultado_ficha`(`idResultadoFicha`, `Seguimiento_idSeguimiento`, `Opcion_Opcion`, `Especialidad_idEspecialidad`, `TipoOpcion`, `Propiedades`, `RespuestaTexto`, `RespuestaValor`, `RespuestaFecha`, `RespuestaAdecuado`, `TipoListado`, `fechaRegistro`) VALUES (NULL,idSeguimiento,id,NULL,5,NULL,NULL,NULL,@Fecha,NULL,NULL,NOW()); 
    ...
    INSERT INTO `tab_resultado_ficha`(`idResultadoFicha`, `Seguimiento_idSeguimiento`, `Opcion_Opcion`, `Especialidad_idEspecialidad`, `TipoOpcion`, `Propiedades`, `RespuestaTexto`, `RespuestaValor`, `RespuestaFecha`, `RespuestaAdecuado`, `TipoListado`, `fechaRegistro`) VALUES (NULL,idSeguimiento,id,NULL,6,@propiedades,NULL,NULL,NULL,Respuesta,NULL,NOW());   

    ELSEIF(tipoOpcion="7")THEN 


    INSERT INTO `tab_resultado_ficha`(`idResultadoFicha`, `Seguimiento_idSeguimiento`, `Opcion_Opcion`, `Especialidad_idEspecialidad`, `TipoOpcion`, `Propiedades`, `RespuestaTexto`, `RespuestaValor`, `RespuestaFecha`, `RespuestaAdecuado`, `TipoListado`, `fechaRegistro`) VALUES (NULL,idSeguimiento,id,NULL,7,NULL,NULL,NULL,NULL,Estado,NULL,NOW()); 

    ELSEIF(tipoOpcion="9")THEN 

    SET @propiedades=(CONCAT('{"tipocampo":',tipoCampo,',"valorCampo":',valorCampo,',"Dosis":',Dosis,',"Num:"',Num,'}'));  

    INSERT INTO `tab_resultado_ficha`(`idResultadoFicha`, `Seguimiento_idSeguimiento`, `Opcion_Opcion`, `Especialidad_idEspecialidad`, `TipoOpcion`, `Propiedades`, `RespuestaTexto`, `RespuestaValor`, `RespuestaFecha`, `RespuestaAdecuado`, `TipoListado`, `fechaRegistro`) VALUES (NULL,idSeguimiento,id,NULL,9,@propiedades,NULL,NULL,NULL,Estado,NULL,NOW());   
...
ELSEIF(tipoGeneral="ESPECIALIDAD")THEN
    ...
    INSERT INTO `tab_resultado_ficha`(`idResultadoFicha`, `Seguimiento_idSeguimiento`, `Opcion_Opcion`, `Especialidad_idEspecialidad`, `TipoOpcion`, `Propiedades`, `RespuestaTexto`, `RespuestaValor`, `RespuestaFecha`, `RespuestaAdecuado`, `TipoListado`, `fechaRegistro`) VALUES (NULL,idSeguimiento,NULL,id,NULL,@propiedades,NULL,NULL,NULL,Estado,NULL,NOW()); 
...
(1, 1, 'admin', '$2a$08$RCuzW/8g2Lg4QMNCfmsa/uKp33rvDmdWrC.P40DOECJlMtPu16NMW', 'Administrador', '2018-09-29 14:03:44', '::1', '2019-02-10 01:26:10');
...
(1, 'DIAGNOSTICO 1', 1, '2019-02-07 00:00:00'),
(2, 'DIAGNOSTICO 2', 1, '2019-02-07 00:00:00');
...
INSERT INTO `tab_resultado_ficha` (`idResultadoFicha`, `Seguimiento_idSeguimiento`, `Opcion_Opcion`, `Especialidad_idEspecialidad`, `TipoOpcion`, `Propiedades`, `RespuestaTexto`, `RespuestaValor`, `RespuestaFecha`, `RespuestaAdecuado`, `TipoListado`, `fechaRegistro`) VALUES
(1, 9, 5, NULL, 3, NULL, NULL, '70.00', NULL, 1, NULL, '2019-03-03 21:08:40'),
(2, 10, 5, NULL, 3, NULL, NULL, '70.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(3, 10, 6, NULL, 3, NULL, NULL, '60.00', NULL, 0, NULL, '2019-03-03 21:09:08'),
(4, 10, 7, NULL, 3, NULL, NULL, '170.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(5, 10, 8, NULL, 3, NULL, NULL, '5.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(6, 10, 9, NULL, 3, NULL, NULL, '56.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(7, 10, 10, NULL, 4, '{\"Sexo\":1}', NULL, '56.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(8, 10, 11, NULL, 3, NULL, NULL, '67.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(9, 10, 12, NULL, 3, NULL, NULL, '57.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(10, 10, 13, NULL, 6, '{\"v1\":1.70,\"v2\":70,\"v3\":,\"v4:\"}', NULL, NULL, NULL, 24, NULL, '2019-03-03 21:09:08'),
(11, 10, 16, NULL, 3, NULL, NULL, '50.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(12, 10, 17, NULL, 3, NULL, NULL, '23.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(13, 10, 18, NULL, 3, NULL, NULL, '1.00', NULL, 1, NULL, '2019-03-03 21:09:08'),
(14, 10, 19, NULL, 3, NULL, NULL, '130.00', NULL, 1, NULL, '2019-03-03 21:09:09'),
(15, 10, 21, NULL, 9, '{\"tipocampo\":2,\"valorCampo\":3,\"Dosis\":,\"Num:\"}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(16, 10, 23, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(17, 10, 24, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(18, 10, 25, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(19, 10, 26, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(20, 10, 27, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(21, 10, 28, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(22, 10, 29, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(23, 10, 30, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(24, 10, 31, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(25, 10, 32, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(26, 10, 33, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(27, 10, 35, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(28, 10, 36, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(29, 10, 38, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":12ff,\"Num:\"12ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(30, 10, 39, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":13ff,\"Num:\"13ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(31, 10, 40, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":14ff,\"Num:\"14ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(32, 10, 41, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":15ff,\"Num:\"15ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(33, 10, 42, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":16ff,\"Num:\"16ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(34, 10, 43, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":17ff,\"Num:\"17ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(35, 10, 44, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":18ff,\"Num:\"18ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(36, 10, 45, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":19ff,\"Num:\"19ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:09'),
(37, 10, 46, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":20ff,\"Num:\"20ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(38, 10, 47, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":21ff,\"Num:\"21ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(39, 10, 48, NULL, 9, '{\"tipocampo\":3,\"valorCampo\":null,\"Dosis\":22ff,\"Num:\"22ff}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(40, 10, 50, NULL, 9, '{\"tipocampo\":4,\"valorCampo\":1,\"Dosis\":,\"Num:\"}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(41, 10, 51, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(42, 10, 53, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(43, 10, 54, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(44, 10, 56, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(45, 10, 57, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(46, 10, 58, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(47, 10, 59, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(48, 10, 60, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(49, 10, 61, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(50, 10, 62, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(51, 10, 64, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(52, 10, 65, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(53, 10, 66, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(54, 10, 67, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(55, 10, 69, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(56, 10, 70, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(57, 10, 71, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(58, 10, 73, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:10'),
(59, 10, 74, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(60, 10, 75, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(61, 10, 76, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(62, 10, 77, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(63, 10, 78, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(64, 10, 112, NULL, 9, '{\"tipocampo\":6,\"valorCampo\":9,\"Dosis\":,\"Num:\"}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(65, 10, 80, NULL, 2, NULL, 'riesgoergrwg', NULL, NULL, NULL, NULL, '2019-03-03 21:09:11'),
(66, 10, 81, NULL, 5, NULL, NULL, NULL, '2019-03-08', NULL, NULL, '2019-03-03 21:09:11'),
(67, 10, 82, NULL, 2, NULL, 'obsevacwef', NULL, NULL, NULL, NULL, '2019-03-03 21:09:11'),
(68, 10, 89, NULL, 9, '{\"tipocampo\":5,\"valorCampo\":1,\"Dosis\":,\"Num:\"}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(69, 10, 90, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(70, 10, 91, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(71, 10, 92, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(72, 10, 93, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(73, 10, 94, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(74, 10, 95, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(75, 10, 96, NULL, 2, NULL, 'efwefew', NULL, NULL, NULL, NULL, '2019-03-03 21:09:11'),
(76, 10, 97, NULL, 5, NULL, NULL, NULL, '2019-03-14', NULL, NULL, '2019-03-03 21:09:11'),
(77, 10, 111, NULL, 2, NULL, 'wefwef', NULL, NULL, NULL, NULL, '2019-03-03 21:09:11'),
(78, 10, 98, NULL, 5, NULL, NULL, NULL, '2019-03-29', NULL, NULL, '2019-03-03 21:09:11'),
(79, 10, 99, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(80, 10, 100, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(81, 10, 101, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:11'),
(82, 10, 102, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(83, 10, 103, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(84, 10, 104, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(85, 10, 105, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(86, 10, 106, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(87, 10, 107, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(88, 10, 108, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(89, 10, 109, NULL, 7, NULL, NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(90, 10, NULL, 4, NULL, '{\"Diagnostico\":1,\"Medico\":1,\"Tratamiento\":gwefgew,\"Observacion:\"weffwe}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(91, 10, NULL, 5, NULL, '{\"Diagnostico\":1,\"Medico\":2,\"Tratamiento\":fwef,\"Observacion:\"wefe}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(92, 10, NULL, 6, NULL, '{\"Diagnostico\":1,\"Medico\":3,\"Tratamiento\":fwef,\"Observacion:\"ewf}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(93, 10, NULL, 7, NULL, '{\"Diagnostico\":2,\"Medico\":1,\"Tratamiento\":fewf,\"Observacion:\"wefew}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(94, 10, NULL, 8, NULL, '{\"Diagnostico\":2,\"Medico\":2,\"Tratamiento\":fwefew,\"Observacion:\"wefew}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(95, 10, NULL, 9, NULL, '{\"Diagnostico\":1,\"Medico\":3,\"Tratamiento\":fwefe,\"Observacion:\"wefew}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(96, 10, NULL, 10, NULL, '{\"Diagnostico\":2,\"Medico\":2,\"Tratamiento\":fewf,\"Observacion:\"ewf}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(97, 10, NULL, 11, NULL, '{\"Diagnostico\":1,\"Medico\":2,\"Tratamiento\":fwefew,\"Observacion:\"fewf}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:12'),
(98, 10, NULL, 12, NULL, '{\"Diagnostico\":2,\"Medico\":2,\"Tratamiento\":fewf,\"Observacion:\"wef}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:13'),
(99, 10, NULL, 13, NULL, '{\"Diagnostico\":1,\"Medico\":1,\"Tratamiento\":fwef,\"Observacion:\"wef}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:13'),
(100, 10, NULL, 14, NULL, '{\"Diagnostico\":2,\"Medico\":1,\"Tratamiento\":fewf,\"Observacion:\"ewfew}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:13'),
(101, 10, NULL, 15, NULL, '{\"Diagnostico\":2,\"Medico\":2,\"Tratamiento\":fwef,\"Observacion:\"wefewf}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:13'),
(102, 10, NULL, 16, NULL, '{\"Diagnostico\":1,\"Medico\":1,\"Tratamiento\":fwef,\"Observacion:\"ewf}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:13'),
(103, 10, NULL, 18, NULL, '{\"Diagnostico\":2,\"Medico\":2,\"Tratamiento\":fwef,\"Observacion:\"wefew}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:13'),
(104, 10, NULL, 19, NULL, '{\"Diagnostico\":1,\"Medico\":1,\"Tratamiento\":fwef,\"Observacion:\"wefew}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:13'),
(105, 10, NULL, 20, NULL, '{\"Diagnostico\":2,\"Medico\":1,\"Tratamiento\":fwef,\"Observacion:\"wef}', NULL, NULL, NULL, 1, NULL, '2019-03-03 21:09:13');
...
(7, 'SEG-1', 4, 1, 13, '2019-03-03 21:04:36'),
(8, 'SEG-2', 4, 1, 13, '2019-03-03 21:05:36'),
(9, 'SEG-3', 4, 1, 13, '2019-03-03 21:08:40'),
(10, 'SEG-4', 4, 1, 13, '2019-03-03 21:09:08');
...
(7, 'Opción Condición'),
(9, 'Opción Condición y Selección'),
(10, 'SubCabecera');
...
--
ALTER TABLE `tab_diagnostico_especialidad`
  MODIFY `idDiagnosticoEspecialidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tab_opcion`
  MODIFY `idOpcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `tab_resultado_ficha`
  MODIFY `idResultadoFicha` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT de la tabla `tab_resultado_pie`
--
ALTER TABLE `tab_resultado_pie`
  MODIFY `idResultadoPie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tab_tipoopcion`
  MODIFY `idTipoOpcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
