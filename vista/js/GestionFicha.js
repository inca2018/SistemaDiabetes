...
function Mostrar_lista(idPaciente,ano,mes){
    if(tabla_seguimientos==null){
         ...
         "ajax":{
            ...
            type : "POST",
            data:{idPaciente:idPaciente,ano:ano,mes:mes},
            dataType : "json",
            error: function(e){
...
function informacion(idSeguimiento,idPaciente,ano,mes){
   limpiar_modal();
    ...
    $('#modal_seguimiento').modal({backdrop: 'static', keyboard: false})
    $("#modal_seguimiento").modal('show');

     $.post("../../controlador/Gestion/CSeguimiento.php?op=recuperarSeguimiento",{idPaciente:idPaciente,idAno:ano,idMes:mes}, function(data, status){
