                  ...
                  <div class="tab-pane fade active show" id="app-settings" role="tabpanel">
                     ...
                     <div class="p-2">
                        ...
                        <div class="row row-flush mb-2">
                           <div class="col mb-2">
                              <div class="setting-color">
                                 <label data-load-css="<?php echo $conexionConfig->ruta(); ?>css/theme-a.css">
                           ...
                           <div class="col mb-2">
                              <div class="setting-color">
                                 <label data-load-css="<?php echo $conexionConfig->ruta(); ?>css/theme-b.css">
                           ...
                           <div class="col mb-2">
                              <div class="setting-color">
                                 <label data-load-css="<?php echo $conexionConfig->ruta(); ?>css/theme-c.css">
                                    <input type="radio" name="setting-theme">
                                    <span class="icon-check"></span>
                                    <span class="split">
                           ...
                           <div class="col mb-2">
                              <div class="setting-color">
                                 <label data-load-css="<?php echo $conexionConfig->ruta(); ?>css/theme-d.css">
                                    <input type="radio" name="setting-theme">
                                    <span class="icon-check"></span>
                                    <span class="split">
                        ...
                        <div class="row row-flush mb-2">
                           <div class="col mb-2">
                              <div class="setting-color">
                                 <label data-load-css="<?php echo $conexionConfig->ruta(); ?>css/theme-e.css">
                                    <input type="radio" name="setting-theme">
                                    <span class="icon-check"></span>
                                    <span class="split">
                           ...
                           <div class="col mb-2">
                              <div class="setting-color">
                                 <label data-load-css="<?php echo $conexionConfig->ruta(); ?>css/theme-f.css">
                                    <input type="radio" name="setting-theme">
                                    <span class="icon-check"></span>
                                    <span class="split">
                           ...
                           <div class="col mb-2">
                              <div class="setting-color">
                                 <label data-load-css="<?php echo $conexionConfig->ruta(); ?>css/theme-g.css">
                                    <input type="radio" name="setting-theme">
                                    <span class="icon-check"></span>
                                    <span class="split">
                           ...
                           <div class="col mb-2">
                              <div class="setting-color">
                                 <label data-load-css="<?php echo $conexionConfig->ruta(); ?>css/theme-h.css">
                                    <input type="radio" name="setting-theme">
                                    <span class="icon-check"></span>
                                    <span class="split">
