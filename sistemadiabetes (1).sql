...
-- Tiempo de generación: 26-11-2018 a las 13:20:16
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_USUARIO_ACTUALIZAR` (IN `usuario` VARCHAR(50), IN `passE` TEXT, IN `idPerfil` INT(11), IN `idEstado` INT(11), IN `idUsuarioU` INT(11), IN `idCreador` INT(11))  NO SQL
BEGIN
...
UPDATE `usuario` SET 		`usuario`=usuario,`Perfil_idPerfil`=idPerfil,`Estado_idEstado`=idEstado WHERE  `idUsuario`= idUsuarioU;
set Mensaje="SE ACTUALIZO EL USUARIO:";
        
else 

UPDATE `usuario` SET 		`usuario`=usuario,`pass`=passE,`Perfil_idPerfil`=idPerfil,`Estado_idEstado`=idEstado WHERE  `idUsuario`= idUsuarioU;
set Mensaje="SE ACTUALIZO EL USUARIO:";
end if;
...
(173, 'ADMINISTRADOR GENERAL DEL SISTEMA', 'ACTUALIZACION', 'USUARIO', 'SE ACTUALIZO EL USUARIO:mrodriguezc', '2018-11-23 01:24:12'),
(174, 'ADMINISTRADOR GENERAL DEL SISTEMA', 'REGISTRO', 'USUARIO', 'SE REGISTRO EL USUARIO:ffernandez', '2018-11-23 01:27:39'),
(175, 'FRANCISCO FERNANDEZ ROMAN', 'ACTUALIZACION', 'USUARIO', 'SE ACTUALIZO EL USUARIO:ffernandezf', '2018-11-23 01:40:56'),
(176, 'ADMINISTRADOR GENERAL DEL SISTEMA', 'ACTUALIZACION', 'USUARIO', 'SE ACTUALIZO EL USUARIO:ffernandezf', '2018-11-23 01:45:07');
...
(1, 1, 'admin', '$2a$08$RCuzW/8g2Lg4QMNCfmsa/uKp33rvDmdWrC.P40DOECJlMtPu16NMW', 'Administrador', '2018-09-29 14:03:44', '::1', '2018-11-23 01:45:11');
...
(51, 'mrodriguezc', '$2a$08$WUmYm6JjA24zSG5CoQ/ii.I3w6tO9V5JFkRJmcHUX.wUJZexGsrwy', 11, 42, 1, '2018-11-21 22:47:07'),
(52, 'ffernandezf', '$2a$08$nBsB6y0.DPuZk/SanUCdMuJS5Fw6MyKUM4SgbqfnW8DZwIWn6.v9K', 11, 43, 1, '2018-11-23 01:27:39');
