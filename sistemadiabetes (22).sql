...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-03-2019 a las 22:04:16
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_REPORTE_GENERAL` (IN `Inicio` DATE, IN `Fin` DATE)  NO SQL
BEGIN 
...
(1, 1, 5, NULL, 3, NULL, NULL, '77.00', NULL, 1, NULL, 1, '2019-03-23 15:50:11'),
(2, 1, 6, NULL, 3, NULL, NULL, '77.00', NULL, 1, NULL, 1, '2019-03-23 15:50:11'),
...
(6, 1, 10, NULL, 4, '{\"Sexo\":1}', NULL, '12.00', NULL, 0, NULL, 1, '2019-03-23 15:50:11'),
...
(9, 1, 13, NULL, 6, '{\"v1\":1.70,\"v2\":77,\"v3\":0,\"v4\":0}', NULL, '26.65', NULL, NULL, NULL, 1, '2019-03-23 15:50:11'),
...
--
ALTER TABLE `tab_opcion`
  MODIFY `idOpcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `tab_resultado_ficha`
  MODIFY `idResultadoFicha` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=313;

--
-- AUTO_INCREMENT de la tabla `tab_resultado_pie`
--
ALTER TABLE `tab_resultado_pie`
  MODIFY `idResultadoPie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
